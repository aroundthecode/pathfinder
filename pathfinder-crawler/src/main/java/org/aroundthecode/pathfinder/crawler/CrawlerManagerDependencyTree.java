...
public class CrawlerManagerDependencyTree {
	...
	public CrawlerManagerDependencyTree(String localRepoPath) throws IOException {
	...
	public void getDirectDependencies(Artifact artifact) throws DependencyResolutionException, DependencyCollectionException, ArtifactDescriptorException {
