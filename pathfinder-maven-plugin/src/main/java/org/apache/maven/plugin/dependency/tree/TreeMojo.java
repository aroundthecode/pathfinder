        ...
        try
        {
            ...
            if ( verbose )
            {
                ...
                dependencyTreeString =
                    serializeVerboseDependencyTree( dependencyTreeBuilder.buildDependencyTree( getProject(),
                                                                                               localRepository,
                                                                                               artifactFilter ) );
            }
            else
            {
                ...
                // running
                rootNode = dependencyGraphBuilder.buildDependencyGraph( getProject(), artifactFilter );
